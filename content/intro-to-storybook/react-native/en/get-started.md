...
Storybook runs alongside your app in development mode. It helps you build UI components isolated from the business logic and context of your app. This edition of Learn Storybook is for React Native; other editions exist for [Vue](/vue/en/get-started) and [Angular](/angular/en/get-started) and [React](/react/en/get-started) [Svelte](/svelte/en/get-started) [random framework](/random-framework/en/get-started).
