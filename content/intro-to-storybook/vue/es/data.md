...
Luego construiremos un simple store Vuex que responde a acciones que cambien el estado de una tarea, en un archivo llamado `src/store.js` (intencionalmente lo mantendremos simple):
