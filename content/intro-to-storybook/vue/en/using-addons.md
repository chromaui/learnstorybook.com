...
If we are [visual testing](/intro-to-storybook/vue/en/test/), we'll also be informed if the truncating solution breaks. Obscure edge cases are liable to be forgotten without test coverage!
