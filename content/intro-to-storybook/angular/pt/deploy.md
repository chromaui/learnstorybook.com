...
<div class="aside"><p>Caso o deploy no Netlify falhe, adicione a flag <a href="https://storybook.js.org/docs/angular/api/cli-options#build-storybook">--quiet </a> ao comando <code>build-storybook</code>.</p></div>
