...
We'll need to make a couple of changes to Storybook's configuration files, so it notices only our recently created stories and allow us to use the application's CSS file (located in `src/index.css`).
