...
Once the first test is complete, we have our test baselines for each story. In other words, we'll have screenshots of the stories we've created so far, these known to be “good”. Any future changes made to our stories we'll be compared to the baselines.
