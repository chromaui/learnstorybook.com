...
description: '開発を加速するアドオンを自分で作る方法を学びます'
commit: 'bebba5d'
---

前に、Storybook の特徴的な機能である、堅牢な[アドオン](https://storybook.js.org/addons/introduction/)のエコシステムを紹介しました。アドオンを使用することで、個人だけでなく、チーム全体の開発効率とワークフローが向上します。

このおまけの章では自分でアドオンを作る方法について見ていきます。アドオンを作るのは困難だと思われるかもしれませんが、そうでもありません。少しの準備をするだけでアドオンの開発を始めることができます。
