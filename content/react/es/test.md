...
Ahora [logueate en Chromatic](https://bit.ly/2Is93Ez) con tú cuenta de GitHub (Chromatic solo te pedirá algunos permisos simples). Crea un proyecto con nombre "taskbox" y copia tu `app-code` único.
