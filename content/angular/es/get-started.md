...
También necesitamos añadir la fuente y el icono de este [directorio](https://github.com/hichroma/learnstorybook-code/tree/master/public) a la carpeta `assets/`.
