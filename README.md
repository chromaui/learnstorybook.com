...
3. See the [guide frontmatter](#guide-frontmatter) section for additional customization options, many of which you'll want to use in order to create a guide that has an impact.
...
4. Using the name of the file that you just created, go back to the guide frontmatter and add the `toc` frontmatter:

```
toc: [":chapter"]
```

This is necessary for building the table of contents for your guide. After you add a new chapter, make sure to go back and update the toc to populate the Table of Contents as well as control the order of the chapters.
